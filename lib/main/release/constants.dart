...
/// the app. Allows creating [constants] for [flavors]part of 'main.dart';
final Map<String, dynamic> _constants = {
  ...
  FlavorEnum.databaseName.key: 'releaseDatabase.db',
  ...
  FlavorEnum.themeFabColor.key: ColorsForTheme(dark: Color(0xfffb9062), light: Color(0xff5d3e5d)),
  FlavorEnum.themeFabIconColor.key: ColorsForTheme(dark: Color(0xff5d3e5d), light: Color(0xfffb9062)),
};
